def tajzie(number):
    avamel = {}
    original_num = number
    # پیدا کردن عامل دو در عدد داده شده تا بعدا بتوانی تعداد تقسیم هارو نصف کنیم که نتیجه سرعت بیشتر خواهد داد
    while number % 2 == 0:
        if not avamel.get('2'):
            avamel['2'] = 0
        avamel['2'] += 1
    ...
    # دلیل شروع از ۳ بخواطر حذف کردن تمامی ضرایب دو میباشد
